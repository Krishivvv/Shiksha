...
function Signup() {
  ...
  return (
    <div className="auth-wrapper fade-in" style={{ position: "relative", overflow: "hidden" }}>
      <div className="aurora-orb" style={{ width: "380px", height: "380px", top: "-100px", right: "-120px", background: "rgba(79,110,247,0.45)" }} />
      <div className="aurora-orb" style={{ width: "320px", height: "320px", bottom: "-80px", left: "-100px", background: "rgba(122,92,255,0.4)", animationDelay: "-7s" }} />
